...
void MX_GPIO_Init(void)
{
  ...
  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(RAD2_CS_GPIO_Port, RAD2_CS_Pin, GPIO_PIN_SET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOD, RAD2_RST_Pin|HGM_Pin|HIGH_G_INT1_Pin|HIGH_G_INT2_Pin
  ...
  GPIO_InitStruct.Pin = RAD2_CS_Pin|IMU2_FSYNC_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  ...
  GPIO_InitStruct.Pin = RAD2_GP2_Pin|RAD2_GP0_Pin|RAD2_GP3_Pin|IMU1_M_DRDY_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_INPUT;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  ...
  GPIO_InitStruct.Pin = RAD2_RST_Pin|HGM_Pin|HIGH_G_INT1_Pin|HIGH_G_INT2_Pin
