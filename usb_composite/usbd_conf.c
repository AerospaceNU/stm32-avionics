...
void HAL_PCD_MspInit(PCD_HandleTypeDef *hpcd)
{
  ...
  // Matt: This is done already in HAL_PCD_MspInit
...
#if defined(USB_IRQn)
  IRQn_Type type = USB_IRQn;
#else
  IRQn_Type type = OTG_FS_IRQn;
#endif
  HAL_NVIC_SetPriority(type, 3 /* hard-coded: customize if needed */, 0);
...
{
  // TODO (matt): I think this is redundant? MX_USB_OTG_FS_PCD_Init does this right?
