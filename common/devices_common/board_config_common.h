...
#define NUM_ACCEL \
  (NUM_ACCEL_H3LIS331DL + NUM_ACCEL_DESKTOP_FILE + NUM_OTHER_ACCEL)
...
#define NUM_IMU                                            \
  (NUM_IMU_LSM9DS1 + NUM_IMU_ICM20948 + NUM_IMU_ICM20600 + \
...
// Magnetometers
#define NUM_MAG                                           \
  (NUM_MAG_IIS2MDC + NUM_IMU_LSM9DS1 + NUM_IMU_ICM20948 + \
