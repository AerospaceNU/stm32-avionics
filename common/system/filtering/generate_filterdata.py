...
with open("filterdata_types.h", "w") as data_file:
    print("/**\n" +
          ...
          " */", file=data_file)
    print("#ifndef COMMON_SYSTEM_FILTERING_FILTERDATA_TYPES_H_", file=data_file)
    print("#define COMMON_SYSTEM_FILTERING_FILTERDATA_TYPES_H_", file=data_file)
    ...
    print("#ifdef __cplusplus\n"
          + '}\n'
          + "#endif\n"
          + "#endif  // COMMON_SYSTEM_FILTERING_FILTERDATA_TYPES_H_", file=data_file)
