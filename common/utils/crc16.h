#ifndef COMMON_UTILS_CRC16_H_
#define COMMON_UTILS_CRC16_H_
...
class CRC16 {
 public:
  CRC16();
  CRC16(uint16_t polynome, uint16_t XORstart, uint16_t XORend, bool reverseIn,
        bool reverseOut);
