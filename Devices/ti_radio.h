...
enum tiRadio_GPIO_Cfg {
	TIRADIO_RXFIFO_THR_PKT = 1, // Associated to the RX FIFO. Asserted when the RX FIFO is filled above
...
enum tiRadio_Packet_Cfg {
	TIRADIO_PKTLEN_FIXED = 0, TIRADIO_PKTLEN_VARIABLE = 0x20
};
...
void tiRadio_SetRadioFrequency(TiRadioCtrl_t *radio, enum TIRADIO_Band band, float frequencyHz);
