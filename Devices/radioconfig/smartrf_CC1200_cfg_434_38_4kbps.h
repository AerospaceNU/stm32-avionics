...
{
  {TIRADIO_IOCFG3,            0x06}, // asserted when sync word, de-asserted at end of packet (in RX)
  {TIRADIO_IOCFG2,            0x01},
  {TIRADIO_IOCFG1,            0x30},
  {TIRADIO_IOCFG0,            0x01},
  ...
  {TIRADIO_FS_DVC1,           0xF7}, // Frequency Synthesizer Divider Chain Configuration ..
  {TIRADIO_FS_DVC0,           0x0F}, // Frequency Synthesizer Divider Chain Configuration ..
