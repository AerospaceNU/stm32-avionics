#ifndef SMARTRF_CC1200_915_H
#define SMARTRF_CC1200_915_H
...
static const  RegisterSetting_t cc1200_916_1_2kbps_cfg[]=
{
  {TIRADIO_IOCFG2,            0x06}, // GPIO2 IO Pin Configuration
  {TIRADIO_SYNC_CFG1,         0xA9}, // Sync Word Detection Configuration Reg. 1
  {TIRADIO_MODCFG_DEV_E,      0x0B}, // Modulation Format and Frequency Deviation Configur..
  ...
  {TIRADIO_SYMBOL_RATE2,      0x8F}, // Symbol Rate Configuration Exponent and Mantissa [1..
  ...
  {TIRADIO_PKT_CFG2,          CCA_MODE_RSSI_LBT << CCA_MODE_SHIFT}, // Packet Configuration Reg. 2
  {TIRADIO_PKT_CFG1,          0b11000011}, // Yes FEC, Yes whiten, otherwise default
  ...
  {TIRADIO_IF_ADC1,           0xEE}, // Analog to Digital Converter Configuration Reg. 1
  {TIRADIO_IF_ADC0,           0x10}, // Analog to Digital Converter Configuration Reg. 0
  ...
  {TIRADIO_FS_DSM0,           0x33}, // FS Digital Synthesizer Module Configuration Reg. 0
  {TIRADIO_FS_DVC0,           0x17}, // Frequency Synthesizer Divider Chain Configuration ..
  {TIRADIO_FS_PFD,            0x00}, // Frequency Synthesizer Phase Frequency Detector Con..
  {TIRADIO_FS_PRE,            0x6E}, // Frequency Synthesizer Prescaler Configuration
  {TIRADIO_FS_REG_DIV_CML,    0x1C}, // Frequency Synthesizer Divider Regulator Configurat..
  {TIRADIO_FS_SPARE,          0xAC}, // Frequency Synthesizer Spare
  {TIRADIO_FS_VCO0,           0xB5}, // FS Voltage Controlled Oscillator Configuration Reg..
