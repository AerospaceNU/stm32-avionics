...
static const registerSetting_t cc1200_433_1_2kbps_cfg[]=
{
  ...
  {CC112X_IOCFG1,            0x30},
  {CC112X_IOCFG0,            0x01},
  {CC112X_DEVIATION_M,       0xD1}, // Frequency Deviation Configuration
  {CC112X_MODCFG_DEV_E,      0x00}, // Modulation Format and Frequency Deviation Configur..
  {CC112X_DCFILT_CFG,        0x5D}, // Digital DC Removal Configuration
  {CC112X_PREAMBLE_CFG0,     0x8A}, // Preamble Detection Configuration Reg. 0
  {CC112X_IQIC,              0xCB}, // Digital Image Channel Compensation Configuration
  {CC112X_CHAN_BW,           0x61}, // Channel Filter Configuration
  {CC112X_MDMCFG1,           0x40}, // General Modem Parameter Configuration Reg. 1
  {CC112X_MDMCFG0,           0x05}, // General Modem Parameter Configuration Reg. 0
  {CC112X_SYMBOL_RATE2,      0x3F}, // Symbol Rate Configuration Exponent and Mantissa [1..
  ...
  {CC112X_AGC_REF,           0x33}, // AGC Reference Level Configuration
  {CC112X_AGC_CS_THR,        0xEC}, // Carrier Sense Threshold Configuration
  {CC112X_AGC_CFG1,          0x51}, // Automatic Gain Control Configuration Reg. 1
  {CC112X_AGC_CFG0,          0x87}, // Automatic Gain Control Configuration Reg. 0
  ...
  {CC112X_MDMCFG2,           0x0C}, // General Modem Parameter Configuration Reg. 2
  ...
  {CC112X_FS_DIG1,           0x07}, // Frequency Synthesizer Digital Reg. 1
  {CC112X_FS_DIG0,           0xAF}, // Frequency Synthesizer Digital Reg. 0
