...
void HM_HardwareInit() {
	...
	// PA/LNA control pins. TODO this seems somewhat code-smell-y since we have CC1200 registers in hardware manager?

	// Both registers need to be inverted since the signal is active low. This is fine since
	// we never go into sleep state anyways
...
bool HM_RadioSend(Hardware_t radioType, uint8_t *data,
		uint16_t numBytes) {
#if defined(HAS_CC1120) || defined(HAS_CC1200)
