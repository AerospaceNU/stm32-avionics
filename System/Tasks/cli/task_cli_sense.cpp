...
void cli_tasks::cliSense() {
  ...
  snprintf(cliStr, sizeof(cliStr),
        "Timestamp (ms): %lu\r\n", data->timestamp_s);
  cliSend(cliStr);
  snprintf(cliStr, sizeof(cliStr), "IMU 1 Accel XYZ (m/s^2): %.3f %.3f %.3f\r\n",
  ...
  cliSend(cliStr);
  snprintf(cliStr, sizeof(cliStr), "IMU 2 Accel XYZ (m/s^2): %.3f %.3f %.3f\r\n",
  ...
  cliSend(cliStr);
  snprintf(cliStr, sizeof(cliStr), "High G Accel XYZ (m/s^2): %.3f %.3f %.3f\r\n",
  ...
  cliSend(cliStr);
  snprintf(cliStr, sizeof(cliStr), "GPS Time: %02i:%02i:%02i %02i/%02i/%04i\r\n",
