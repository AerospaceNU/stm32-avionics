...
#define NUM_PYRO (NUM_PYRO_DIGITAL + NUM_PYRO_DESKTOP_PRINT + NUM_PYRO_DESKTOP_NT)

#define FIRST_ID_PYRO_DIGITAL 0
#define FIRST_ID_PYRO_DESKTOP_PRINT (FIRST_ID_PYRO_DIGITAL + NUM_PYRO_DIGITAL)
#define FIRST_ID_PYRO_DESKTOP_NT (FIRST_ID_PYRO_DESKTOP_PRINT + NUM_PYRO_DESKTOP_PRINT)
...
#define NUM_RADIO \
  (NUM_RADIO_TI_433 + NUM_RADIO_TI_915 + NUM_RADIO_DESKTOP_SOCKET + NUM_NT_INTERFACE)
