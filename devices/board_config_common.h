...
#ifndef NUM_RADIO_USB
#define NUM_RADIO_USB 0
#endif // NUM_RADIO_USB
...
#define NUM_FLASH (NUM_FLASH_S25FLX + NUM_FLASH_DESKTOP_FILE_BACKED + NUM_FLASH_MB85RSX)
...
#define NUM_IMU (NUM_IMU_LSM9DS1 + NUM_IMU_ICM20948 + NUM_IMU_ICM20600 + NUM_IMU_DESKTOP_FILE)
...
// Magnetometers
#define NUM_MAG (NUM_MAG_IIS2MDC + NUM_IMU_LSM9DS1 + NUM_IMU_ICM20948)
...
#define NUM_RADIO \
  (NUM_RADIO_TI_433 + NUM_RADIO_TI_915 + NUM_RADIO_DESKTOP_SOCKET + NUM_RADIO_USB)
...
//#define FIRST_ARRAY_INDEX_VBAT (FIRST_ARRAY_INDEX_PYRO_CONT_ADC + NUM_PYRO_CONT_ADC)
