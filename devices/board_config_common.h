...
#ifndef NUM_PYRO_DESKTOP_NT
#define NUM_PYRO_DESKTOP_NT 0
#endif  // NUM_PYRO_DESKTOP_NT
#ifndef NUM_PYRO_SIM_KRPC
#define NUM_PYRO_SIM_KRPC 0
#endif  // NUM_PYRO_SIM_KRPC
...
#ifndef NUM_NT_INTERFACE
#define NUM_NT_INTERFACE 0
#endif  // NUM_NT_INTERFACE
#ifndef DO_RADIO_HACK
#define DO_RADIO_HACK 1
#endif  // DO_RADIO_HACK
...
#define NUM_PYRO \
  (NUM_PYRO_DIGITAL + NUM_PYRO_DESKTOP_PRINT + NUM_PYRO_SIM_KRPC + NUM_PYRO_DESKTOP_NT)

#define FIRST_ID_PYRO_DIGITAL 0
#define FIRST_ID_PYRO_DESKTOP_PRINT (FIRST_ID_PYRO_DIGITAL + NUM_PYRO_DIGITAL)
#define FIRST_ID_PYRO_SIM_KRPC (FIRST_ID_PYRO_DESKTOP_PRINT + NUM_PYRO_DESKTOP_PRINT)
#define FIRST_ID_PYRO_DESKTOP_NT \
  (FIRST_ID_PYRO_SIM_KRPC + NUM_PYRO_DESKTOP_SIM_KRPC)
