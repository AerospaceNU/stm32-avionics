...
typedef struct INA226Ctrl_s {
  ...
  VbatIna226Avg_t avg;        // default: INA226_AVG_1
  VbatIna226Vbusct_t vbusct;  // default: INA226_VBUSCT_1100us
  VbatIna226Vshct_t vshct;    // default: INA226_VSHCT_1100us
  VbatIna226Mode_t mode;      // default: INA226_MODE_SH_BUS_C
} VbatIna226Ctrl_t;

bool vbatIna226_init(VbatIna226Ctrl_t* ina226);
void vbatIna226_calibrate(VbatIna226Ctrl_t* ina226);               // static
void vbatIna226_configure(VbatIna226Ctrl_t* ina226);               // static
float vbatIna226_getMaxCurrentPossible(VbatIna226Ctrl_t* ina226);  // static
float vbatIna226_getMaxCurrent(VbatIna226Ctrl_t* ina226);          // static
float vbatIna226_getMaxShuntVoltage(VbatIna226Ctrl_t* ina226);     // static
float vbatIna226_getMaxPower(VbatIna226Ctrl_t* ina226);            // static
