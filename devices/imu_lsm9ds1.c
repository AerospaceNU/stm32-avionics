...
void lsm9ds1_getData(ImuLsm9ds1Ctrl_s *sensor) {
  ...
  sensor->agData.angVelRealRadps.x = sensor->ag.gRes * sensor->agData.angVelRaw.x;
  sensor->agData.angVelRealRadps.y = sensor->ag.gRes * sensor->agData.angVelRaw.y;
  sensor->agData.angVelRealRadps.z = sensor->ag.gRes * sensor->agData.angVelRaw.z;
