...
const RegisterSetting_s cc1120_433_1_2kbps_cfg[] = {
    ...
    {TIRADIO_IQIC, 0xC6},  // Digital Image Channel Compensation Configuration
    {TIRADIO_CHAN_BW, 0x08},     // Channel Filter Configuration
    ...
    {TIRADIO_PA_CFG2, 0x69},     // Power Amplifier Configuration Reg. 2
