/**
 * smartrf_cc1200_cfg_434_38_4kbps.h
 */

#ifndef STM32_PROJECTS_DEVICE_DRIVERS_RADIOCONFIG_SMARTRF_CC1200_CFG_434_38_4KBPS_H_
#define STM32_PROJECTS_DEVICE_DRIVERS_RADIOCONFIG_SMARTRF_CC1200_CFG_434_38_4KBPS_H_
...
const RegisterSetting_s cc1200_433_1_2kbps_cfg[] = {
    ...
    {TIRADIO_PKT_CFG1,  // No FEC, No whiten, no PN9 swap, no address, default
                        // CRC cfg, status appended
     (0 << 7) | (0 << 6) | (0 << 5) | (0b00 << 3) | (0b01 << 1) | (1 << 0)},
...
#endif  // STM32_PROJECTS_DEVICE_DRIVERS_RADIOCONFIG_SMARTRF_CC1200_CFG_434_38_4KBPS_H_
