...
#ifndef STM32_PROJECTS_DEVICE_DRIVERS_INTERNAL_FLASH_H_
#define STM32_PROJECTS_DEVICE_DRIVERS_INTERNAL_FLASH_H_
...
#endif  // STM32_PROJECTS_DEVICE_DRIVERS_INTERNAL_FLASH_H_
