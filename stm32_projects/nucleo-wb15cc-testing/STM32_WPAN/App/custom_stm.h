...
{
  /* txdlong */
  CUSTOM_STM_TXD_READ_EVT,
  CUSTOM_STM_TXD_NOTIFY_ENABLED_EVT,
  CUSTOM_STM_TXD_NOTIFY_DISABLED_EVT,
  /* rxdlong */
  CUSTOM_STM_RXD_WRITE_EVT,
...
/* Exported constants --------------------------------------------------------*/
extern uint8_t SizeTxd;
extern uint8_t SizeRxd;
