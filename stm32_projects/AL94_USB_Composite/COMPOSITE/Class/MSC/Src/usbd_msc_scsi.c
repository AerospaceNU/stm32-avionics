...
int8_t SCSI_ProcessCmd(USBD_HandleTypeDef *pdev, uint8_t lun, uint8_t *cmd) {
  ...
  USBD_MSC_BOT_HandleTypeDef *hmsc =
      (USBD_MSC_BOT_HandleTypeDef *)(pdev->pClassData_MSC);
...
static int8_t SCSI_Inquiry(USBD_HandleTypeDef *pdev, uint8_t lun,
  ...
  if ((params[1] & 0x01U) != 0U) /* Evpd is set */
  {
    ...
    pPage = (uint8_t *)&((USBD_StorageTypeDef *)pdev->pUserData_MSC)
...
static int8_t SCSI_ReadCapacity10(USBD_HandleTypeDef *pdev, uint8_t lun,
  ...
  ret = ((USBD_StorageTypeDef *)pdev->pUserData_MSC)
...
static int8_t SCSI_Write10(USBD_HandleTypeDef *pdev, uint8_t lun,
  ...
  if (hmsc->bot_state == USBD_BOT_IDLE) /* Idle */
  {
    ...
    if (((USBD_StorageTypeDef *)pdev->pUserData_MSC)->IsWriteProtected(lun) !=
        0) {
...
static int8_t SCSI_ProcessRead(USBD_HandleTypeDef *pdev, uint8_t lun) {
  ...
  if (((USBD_StorageTypeDef *)pdev->pUserData_MSC)
