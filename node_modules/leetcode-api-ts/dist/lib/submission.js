...
var Submission = /** @class */ (function () {
    function Submission(id, isPending, lang, memory, runtime, status, timestamp, code) {
        this.id = id;
    ...
    Submission.setUris = function (uris) {
        Submission.uris = uris;
    };
    Submission.prototype.detail = function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        this.status = helper_1.default.submissionStatusMap(response.match(/parseInt\('(\d+)', 10/)[1]);
