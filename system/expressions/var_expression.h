#ifndef TASKS_EXPRESSIONS_VAR_EXPRESSION_H_
#define TASKS_EXPRESSIONS_VAR_EXPRESSION_H_
...
public:
     ...
     * @param dataMember The filterdata member that this expression will evaluate to.
     */
...
#endif  // TASKS_EXPRESSIONS_VAR_EXPRESSION_H_
