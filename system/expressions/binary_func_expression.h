#ifndef TASKS_EXPRESSIONS_BINARY_FUNC_EXPRESSION_H_
#define TASKS_EXPRESSIONS_BINARY_FUNC_EXPRESSION_H_
 ...
 */
using BinaryFunction = void(Expression *expr, FilterData_s *filterData, Expression *op1, Expression *op2);
...
public:
    ...
    BinaryFunctionWrapper(const char *stringRep,
                          BinaryFunction *function,
                          ExpressionValueType_e op1Type,
                          ExpressionValueType_e op2Type,
                          ExpressionValueType_e valueType);
...
private:
    ...
    uint16_t operand2ID;
public:
    BinaryFuncExpression(int triggerNum, BinaryFunction_e opcode, uint16_t operand1ID, uint16_t operand2ID) :
...
#endif  // TASKS_EXPRESSIONS_BINARY_FUNC_EXPRESSION_H_
