...
/**
 * See
 * http://web.archive.org/web/20240122230227/https://www.maptools.com/tutorials/lat_lon/formats
 * for information about Lat/Long formats. To convert from degrees and decimal
 * minutes to decimal degrees, separate out the hundreds place and up (degrees).
 * The rest is the minutes and can be divided by 60 to get the digits that
 * should go after the decimal place.
 *
